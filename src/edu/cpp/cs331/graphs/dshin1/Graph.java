...
import edu.cpp.cs331.graphs.dshin1.Graph.VertexAlreadyExistsException;
...
public class Graph {
	...
	//this section of code was used for graph theory mat370
	
	public static Graph genGraphTheorygraph() throws VertexAlreadyExistsException
	{
		Vertex v;
		Graph g = new Graph();
		...
		try{
			g.addEdge(new DirectedEdge(g.vList.get(0),g.vList.get(1),1));
			g.addEdge(new DirectedEdge(g.vList.get(0),g.vList.get(2),4));
			g.addEdge(new DirectedEdge(g.vList.get(0),g.vList.get(3),4));
			g.addEdge(new DirectedEdge(g.vList.get(0),g.vList.get(4),5));
			g.addEdge(new DirectedEdge(g.vList.get(2),g.vList.get(3),6));
			g.addEdge(new DirectedEdge(g.vList.get(3),g.vList.get(4),2));
			g.addEdge(new DirectedEdge(g.vList.get(1),g.vList.get(2),3));
			g.addEdge(new DirectedEdge(g.vList.get(1),g.vList.get(3),7));
			g.addEdge(new DirectedEdge(g.vList.get(1),g.vList.get(4),5));
	...
	private static int genRandomEdgeWeight(Random gen, int size) {
		return gen.nextInt(Integer.MAX_VALUE / size)%20 +1;
	}
